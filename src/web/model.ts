...
export type FileStats = {ip: string, model: string, os: string, type: string, city: string, stateOrProvince: string, countryOrRegion: string, browser: string, timestamp: string}[]
